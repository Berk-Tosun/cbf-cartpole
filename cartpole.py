...
class CartPole:
    ...
    def set_control_law(self, c:Controller):
        self.control_law = c  # type: ignore
        self._gen_dynamics()
...
def visualize(cp:CartPole, y, t, dt, save=None):
    """
    Args:
        cp: CartPole instance
    ...
    a_x2 = cp.l * np.sin(y[:, 2]) + a_x1
    a_y2 = -cp.l * np.cos(y[:, 2]) + a_y1
